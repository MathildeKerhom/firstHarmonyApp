...
public class PokemonProviderBase extends ContentProvider {
    ...
    /* Tools / Common. */
    /** com.mathildekerhom.pokemon.provider authority. */
    public static String authority = "com.mathildekerhom.pokemon.provider";
    /** URI Matcher. */
    ...
    public void loadAdapters() {
        ...
        TypePokemonProviderAdapter typePokemonProviderAdapter = new TypePokemonProviderAdapter(this);
        this.db = typePokemonProviderAdapter.getDb();
        this.providerAdapters.add(typePokemonProviderAdapter);
