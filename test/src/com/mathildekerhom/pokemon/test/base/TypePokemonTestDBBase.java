/**************************************************************************
 * TypePokemonTestDBBase.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 */
public abstract class TypePokemonTestDBBase extends TestDBBase {
    ...
    public void testCreate() {
        ...
        if (this.entity != null) {
            ...
            result = (int)this.adapter.insert(typePokemon);
    ...
    public void testUpdate() {
        ...
        if (this.entity != null) {
            ...
            result = (int) this.adapter.update(typePokemon);
